 ...
 * This file demonstrates how to integrate Sparkurn with a web frontend
 */

// For React/Vue/Angular applications
export class SparkurnClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new SparkurnClient(provider, contractAddress);
